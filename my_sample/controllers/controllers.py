    ...
    def validar_tramites(self, **kw):
        ...
        if self.validar_captcha(kw.get('token')):
            if origen == 'renovacion':
                ...
                if (dias < 0):
                    #return { 'ok': 'True'}
                    #return { 'ok': 'False', 'messaje': 'va por dias < 0:  fecha expiracion' + str(fecha_expiracion) + ' dias: ' + str(dias) }
                    return { 'ok': 'False', 'messaje': 'va por dias < 0: try: dias' + str(dias) + ' fecha expiracion: ' + str(fecha_expiracion) + ' now: ' + str(now) + '/' + str(timedelta(days=1)) + ' except: dias' + str(dias) + ' fecha expiracion: ' + str(fecha_expiracion) + ' ano: ' + str(ano) + ' now: ' + str(now) + '/' + str(timedelta(days=1)) }
                else:
                    ...
                    #return { 'ok': 'False', 'messaje': 'Fecha Expiracion:'  + str(fecha_expiracion) + ' dias: ' + str(dias) }
                    return { 'ok': 'False', 'messaje': 'false: try: dias' + str(dias) + ' fecha expiracion: ' + str(fecha_expiracion) + ' now: ' + str(now) + '/' + str(timedelta(days=1)) + ' except: dias' + str(dias) + ' fecha expiracion: ' + str(fecha_expiracion) + ' ano: ' + str(ano) + ' now: ' + str(now) + '/' + str(timedelta(days=1)) }
